...
def get_parsed_arguments():
    ...
    parser.add_argument("-k","--topk", dest="topk", help="Numbers of classes predicted", default=5, type=int)
...
def main():
    ...
    flowers = [cat_to_name[str(int(i))] for i in names]
    utils.display(flowers, probs)
