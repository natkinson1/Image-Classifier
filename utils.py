...
def load_data(path, pin_memory):
    ...
    dataloaders = {
    'training' : torch.utils.data.DataLoader(image_datasets['training'], batch_size=64, shuffle=True, pin_memory=pin_memory) ,
    'validation' : torch.utils.data.DataLoader(image_datasets['validation'], batch_size=32, pin_memory=pin_memory) ,
    'test' : torch.utils.data.DataLoader(image_datasets['test'], batch_size=32, pin_memory=pin_memory)
    }
